...
const { registerUser, loginUser, logoutUser, changeUserPassword, getUserProfile, UpdateProfileDetails, sendOtp, resetPassword, otpLimiter } = require("../controllers/userController.js");
...
authRouter.post('/sendotp', otpLimiter,sendOtp);
